 ...
 */
public class AgentReliabilityModel implements GameEventListenr {
    ...
    public AgentReliabilityModel(Game game) {
    ...
    public void handleEvent(Game g, GameEvent e) {
        switch (e.type) {
            ...
            case MEDIUM:
                ...
                GameAgent executed = game.getLastEventOf(EventType.EXECUTE).target;
                game.getUniqueTalks().filter(tk
                    -> (tk.getTopic() == Topic.DIVINED || tk.getTopic() == Topic.ESTIMATE)
