 ...
 *
 */
public class TalkFrequencyModel implements GameEventListenr, MetagameEventListener {
    ...
    private Map<Topic, Double> getCommonTCP(int day, int turn, Role role) {
        ...
        if (P == null) {
            P = new HashMap<>();
            String filename = game.getVillageSize() == 15 ? "talkFrequency15.dat" : "talkFrequency5.dat";
            try (BufferedReader br = new BufferedReader(new InputStreamReader(TalkFrequencyModel.class.getClassLoader().getResourceAsStream("jp/ne/sakura/vopaldragon/aiwolf/cedec2017impl/metagame/" + filename)))) {;
                String line = null;
